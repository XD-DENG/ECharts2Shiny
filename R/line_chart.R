...
renderLineChart <- function(div_id,
  ...
  js_statement <- paste("var " ,
                        ...
                        "yAxis:{type: 'value', name:'", axis.y.name, "', axisLabel:{rotate:",rotate.axis.y,",textStyle:{fontSize:", font.size.axis.y, "}}}, ",
                        "xAxis:{type:'category', name:'", axis.x.name, "' boundaryGap: false, axisLabel:{rotate:", rotate.axis.x, ",textStyle:{fontSize:", font.size.axis.x, "}}, data:",
                        xaxis_name,
                        "}, series:[",
                        series_data,
                        "]};",
