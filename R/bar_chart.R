...
renderBarChart <- function(div_id,
  ...
  js_statement <- paste("var " ,
                        ...
                        direction_vector[1],
                        ":[{type:'value', name:'", axis.y.name, "', axisLabel:{rotate:", rotate.axis.y, ",textStyle:{fontSize:", font.size.axis.y, "}}}], ",
                        direction_vector[2],
                        ":[{type:'category', name:'", axis.x.name, "', axisTick:{show:false}, axisLabel:{rotate:", rotate.axis.x, ",textStyle:{fontSize:", font.size.axis.x, "}}, data:",
                        xaxis_name,
                        "}],series :",
                        series_data,
                        "};",
